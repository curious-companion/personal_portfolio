    ...
    const projectsArray = [
        {
          ...
          repoUrl: "https://github.com/curious-companion/talent_trajectory", // update your real repo link
          siteUrl: "https://talent-trajectory.vercel.app/", // update your real site link
          isReversed: false,
        ...
        },
        {
          ...
          repoUrl: "https://github.com/curious-companion/pyChan", // update your real repo link
          siteUrl: "https://skc-vibhanshu-pychan.vercel.app/", // update your real site link
          isReversed: true,
          className: "project-card",
          cardStyles: {
            height: "400px",
        ...
        },
        {
          ...
          repoUrl: "https://github.com/curious-companion/VibeVault", // update your real repo link
          siteUrl: "https://vibe-vault-git-main-vibhanshu-jains-projects-198d7ba8.vercel.app/", // update your real site link
          isReversed: false,
          className: "project-card",
          cardStyles: {
            height: "400px",
        ...
        },
        {
          ...
          repoUrl: "https://github.com/curious-companion/personal_portfolio", // update your real repo link
          siteUrl: "https://personal-portfolio-eight-wine-96.vercel.app/", // update your real site link
          isReversed: true,
          className: "project-card",
          cardStyles: {
            height: "400px",
