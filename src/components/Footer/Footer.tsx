            ...
            <Box
                ...
                <Grid
                    ...
                    <Grid item xs={12} sm={3} md={3}>
                        ...
                        <Box className='link' sx={styles}>
                            <a target='_blank' rel="noreferrer" href='https://github.com/curious-companion'>Github</a>
                            <Typography variant='h1' fontSize='1em'>vibhanshujain2003@gmail.com</Typography>
                            <Typography variant='h1' fontSize='1em'>Delhi, India</Typography>
                            <Typography variant='h1' fontSize='1em'>+91 7011845449</Typography>
                        </Box>
                    </Grid>
                </Grid>
            </Box>
