...
const Layout = ({navbarSx, title ,children ,desc } : ILayout) => {
  ...
  return (
    ...
    <>
    <Head >
        <title>{title || "Vibhanshu Jain Personal Portfolio | Full Stack Web Developer"}</title>
        <meta name="viewport" content="initial-scale=1.0, width=device-width" />
        <link rel="shortcut icon" href="https://res.cloudinary.com/dwcu3wcol/image/upload/v1657099811/log_nkmcys.jpg" />
  
   
    
<meta name="description" content={`${desc || 'Vibhanshu Jain personal portfolio, An expert in UI/UX and building complex websites and applications'}`} />


<meta property="og:title" content="Vibhanshu Jain Personal Portfolio | Full Stack Web Developer" />


<meta property="og:url" content="https://elvito.netlify.app" />


<meta property="og:description" content="Vibhanshu Jain | Full Stack Developer from Delhi/India And this is my Portfolio and my blog "/>
